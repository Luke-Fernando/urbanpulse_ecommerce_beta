...
<section id="add-review" class="container h-auto mx-auto mb-52 box-border px-4 sm:px-0">
    <?php
    ...
    <div class="w-full h-auto flex justify-between items-start border-t border-b py-3">
        <a href="#" class="w-36 sm:w-52 p-3 sm:p-0 aspect-square flex justify-center items-center overflow-hidden">
            <img src="../assets/images/products/<?php echo $product_image; ?>" class="min-h-full min-w-full object-cover" alt="">
        </a>
